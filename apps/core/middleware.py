    ...
    def middleware(request):
        ...
        share(
            ...
            usuario={
                ...
                'contacto': ContactoSerializer(request.user.contacto).data if request.user.is_authenticated and request.user.contacto else None,
            },
            contacto=ContactoSerializer(request.user.contacto).data if getattr(request.user, 'contacto', None) else None,
