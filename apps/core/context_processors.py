...
from apps.core.navigation import build_default_menu, build_compras_menu, build_directorio_menu, build_default_dock, \
    build_compras_dock
...
def navbar_menu(request):
    ...
    elif request.path.startswith('/directorio/'):
