...
class Obra(models.Model):
    ...
    estructura = models.ForeignKey(Estructura, on_delete=models.CASCADE, related_name="obras")
    cantidad = models.PositiveIntegerField(help_text='Cantidad de viviendas')

    def __str__(self):
        return f"{self.nombre} | {self.etapa} | {self.estructura} | {self.cantidad}"
...
class Vivienda(models.Model):
    ...
    def __str__(self):
        return f"Viv {self.numero} | {self.obra}"
...
class DestajoDetalle(models.Model):
    ...
    def clean(self):
        ...
        obra = self.destajo.obra
        estructura = self.destajo.obra.estructura
        ...
        cantidad_maxima = cantidad_presupuestada * Decimal(obra.cantidad)
