...
to {
  ...
  animation: ${ie} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,oe=({toast:e})=>{let{icon:t,type:n,iconTheme:r}=e;return t===void 0?n===`blank`?null:i.createElement(re,null,i.createElement(K,{...r}),n!==`loading`&&i.createElement(X,null,n===`error`?i.createElement(W,{...r}):i.createElement(Y,{...r}))):typeof t==`string`?i.createElement(ae,null,t):t},se=e=>`
...
`,pe=(e,t)=>{let n=e.includes(`top`)?1:-1,[r,i]=T()?[le,ue]:[se(n),ce(n)];return{animation:t?`${b(r)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${b(i)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},me=i.memo(({toast:e,position:t,style:n,children:r})=>{let a=e.height?pe(e.position||t||`top-center`,e.visible):{opacity:0},o=i.createElement(oe,{toast:e}),s=i.createElement(fe,{...e.ariaProps},C(e.message,e));return i.createElement(de,{className:e.className,style:{...a,...n,...e.style}},typeof r==`function`?r({icon:o,message:s}):i.createElement(i.Fragment,null,o,s))});ee(i.createElement);var he=({id:e,className:t,style:n,onHeightUpdate:r,children:a})=>{let o=i.useCallback(t=>{if(t){let n=()=>{let n=t.getBoundingClientRect().height;r(e,n)};n(),new MutationObserver(n).observe(t,{subtree:!0,childList:!0,characterData:!0})}},[e,r]);return i.createElement(`div`,{ref:o,className:t,style:n},a)},ge=(e,t)=>{let n=e.includes(`top`),r=n?{top:0}:{bottom:0},i=e.includes(`center`)?{justifyContent:`center`}:e.includes(`right`)?{justifyContent:`flex-end`}:{};return{left:0,right:0,display:`flex`,position:`absolute`,transition:T()?void 0:`all 230ms cubic-bezier(.21,1.02,.73,1)`,transform:`translateY(${t*(n?1:-1)}px)`,...r,...i}},_e=g`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,Z=16,ve=({reverseOrder:e,position:t=`top-center`,toastOptions:n,gutter:r,children:a,toasterId:o,containerStyle:s,containerClassName:c})=>{let{toasts:l,handlers:u}=B(n,o);return i.createElement(`div`,{"data-rht-toaster":o||``,style:{position:`fixed`,zIndex:9999,top:Z,left:Z,right:Z,bottom:Z,pointerEvents:`none`,...s},className:c,onMouseEnter:u.startPause,onMouseLeave:u.endPause},l.map(n=>{let o=n.position||t,s=ge(o,u.calculateOffset(n,{reverseOrder:e,gutter:r,defaultPosition:t}));return i.createElement(he,{id:n.id,key:n.id,onHeightUpdate:u.updateHeight,className:n.visible?_e:``,style:s},n.type===`custom`?C(n.message,n):a?a(n):i.createElement(me,{toast:n,position:o}))}))},Q=r(),$={success:{borderClass:`border-l-4 border-success`,iconBg:`bg-success/10 text-success`,icon:`icon-[heroicons--check-circle-20-solid]`,title:`Éxito`},error:{borderClass:`border-l-4 border-error`,iconBg:`bg-error/10 text-error`,icon:`icon-[heroicons--x-circle-20-solid]`,title:`Error`},warning:{borderClass:`border-l-4 border-warning`,iconBg:`bg-warning/10 text-warning`,icon:`icon-[heroicons--exclamation-triangle-20-solid]`,title:`Atención`},info:{borderClass:`border-l-4 border-info`,iconBg:`bg-info/10 text-info`,icon:`icon-[heroicons--information-circle-20-solid]`,title:`Información`},debug:{borderClass:`border-l-4 border-neutral`,iconBg:`bg-neutral/10 text-neutral-content`,icon:`icon-[heroicons--code-bracket-20-solid]`,title:`Debug`}},ye=e=>{let t=(0,a.c)(22),{t:n,item:r}=e,i=$[r.level]||$.info,o=`
                ...
                ${n.visible?`opacity-100 translate-y-0 scale-100`:`opacity-0 translate-y-2 scale-95`}
            `,s=`p-1.5 rounded-lg shrink-0 ${i.iconBg}`,c=`${i.icon} text-lg`,l;t[0]===c?l=t[1]:(l=(0,Q.jsx)(`span`,{className:c}),t[0]=c,t[1]=l);let u;t[2]!==s||t[3]!==l?(u=(0,Q.jsx)(`div`,{className:s,children:l}),t[2]=s,t[3]=l,t[4]=u):u=t[4];let d;t[5]===i.title?d=t[6]:(d=(0,Q.jsx)(`p`,{className:`text-[10px] font-bold uppercase tracking-wider text-base-content/50 mb-0.5`,children:i.title}),t[5]=i.title,t[6]=d);let f;t[7]===r.message?f=t[8]:(f=(0,Q.jsx)(`p`,{className:`text-xs font-medium text-base-content/90 leading-relaxed break-words`,children:r.message}),t[7]=r.message,t[8]=f);let p;t[9]!==d||t[10]!==f?(p=(0,Q.jsxs)(`div`,{className:`flex-1 pt-0.5 min-w-0`,children:[d,f]}),t[9]=d,t[10]=f,t[11]=p):p=t[11];let m;t[12]===n.id?m=t[13]:(m=()=>R.dismiss(n.id),t[12]=n.id,t[13]=m);let h;t[14]===Symbol.for(`react.memo_cache_sentinel`)?(h=(0,Q.jsx)(`span`,{className:`icon-[heroicons--x-mark-20-solid] text-sm`}),t[14]=h):h=t[14];let g;t[15]===m?g=t[16]:(g=(0,Q.jsx)(`button`,{type:`button`,onClick:m,className:`btn btn-ghost btn-xs btn-circle text-base-content/40 hover:text-base-content shrink-0 -mr-1 -mt-1`,title:`Cerrar`,children:h}),t[15]=m,t[16]=g);let _;return t[17]!==o||t[18]!==g||t[19]!==u||t[20]!==p?(_=(0,Q.jsxs)(`div`,{className:o,children:[u,p,g]}),t[17]=o,t[18]=g,t[19]=u,t[20]=p,t[21]=_):_=t[21],_},be=e=>{let t=`${e.level}-${e.message}`;R.custom(t=>(0,Q.jsx)(ye,{t,item:e}),{id:t,duration:4e3,position:`top-right`})};export{ve as n,be as t};